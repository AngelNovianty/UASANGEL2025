...
<div class="wrapper">
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Apakah ada Dokter Jantung?</p>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Bisa daftar ruang inap offline ga?</p>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Tempat parkir motor sebelah mana ya?</p>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="../../dist/img/AdminLTELogo.png" alt="Website Rumah Sakit" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
<img src="<?= base_url('assets/img/rumahsakit.jpg') ?>" alt="Logo" class="brand-image img-circle">        </div>
        <div class="info">
          <a href="#" class="d-block">AngelHope Hospital</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <?php if ( $level == 'user') : ?>
              <li class="nav-item">
                <a href="<?= base_url('pendaftaran_user'); ?>" class="nav-link">
